...
@property (nonatomic, strong) AVCaptureVideoPreviewLayer * scanView;//扫描视图

@property (nonatomic, strong) CAShapeLayer * maskLayer;//遮掩层
@property (nonatomic, strong) CAShapeLayer * shadowLayer;//阴影层
@property (nonatomic, strong) CAShapeLayer * scanRectLayer;//扫描框
